    ...
    <AdminLayout>
      <div className="space-y-8">
        ...
        <div className="bg-card border border-border rounded-2xl p-6">
          <h2 className="text-lg font-semibold text-card-foreground mb-6">Bookings per Day (Last 30 days)</h2>
          {chartLoading ? (
        ...
        {/* Revenue chart */}
        <div className="bg-card border border-border rounded-2xl p-6">
          <h2 className="text-lg font-semibold text-card-foreground mb-6">Revenue per Day ($)</h2>
          {chartLoading ? (
            <Skeleton className="h-56" />
          ) : (
            <ResponsiveContainer width="100%" height={220}>
        ...
        {/* Top Services */}
        <div className="bg-card border border-border rounded-2xl p-6">
          <h2 className="text-lg font-semibold text-card-foreground mb-6">Top Services by Bookings</h2>
          {topLoading ? (
            <Skeleton className="h-56" />
            ...
            <ResponsiveContainer width="100%" height={220}>
              <BarChart data={topServices}>
                <CartesianGrid strokeDasharray="3 3" stroke="hsl(var(--border))" />
                <XAxis dataKey="serviceName" tick={{ fontSize: 11 }} stroke="hsl(var(--muted-foreground))" />
