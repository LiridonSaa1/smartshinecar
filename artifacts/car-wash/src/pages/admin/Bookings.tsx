          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="md:hidden divide-y divide-border">
                {filtered.map((b) => (
                  <div key={b.id} className="p-4 space-y-2" data-testid={`row-booking-${b.id}`}>
                    <div className="flex items-start justify-between gap-2">
                      <div className="min-w-0">
                        <p className="font-medium text-card-foreground truncate">{b.customerName}</p>
                    ...
                    <p className="text-sm text-card-foreground">{b.serviceName}</p>
